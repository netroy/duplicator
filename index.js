(function() {
  ...
  var ERR_MSG = {
    'MULTIPLE_FWD': "Cowardly refusing to forward a connection to multiple destinations. " +
                    "Using `duplicate` instead.",
    'FWD_CONN_ERROR': "Error connection to forward host:"
  };
  ...
  function makeConnect(host) {
    return function(cb) {
      return net.connect(host.port, host.name, cb);
    };
  }
